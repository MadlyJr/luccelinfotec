...
(function(){
  ...
  slides.forEach(s => {
    ...
    img.addEventListener('click', (e) => {
      ...
      pulse.style.cssText = 'position:absolute;pointer-events:none;border-radius:50%;background:radial-gradient(circle,rgba(0,119,255,0.6),transparent);animation:clickPulse 0.6s ease-out;';
